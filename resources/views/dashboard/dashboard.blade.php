...
@section('content')
    <div class="col-lg-5">
        <div class="card border-0 rounded-3 welcome-box mb-4 position-relative z-1 overflow-hidden"
                ...
                <div class="row align-items-center">
                    <div class="col-9 col-lg-9 col-sm-6 col-xl-10 col-xxl-7">
                        <div class="border-bottom" style="border: 0 !important; padding-bottom: 35px;">
                            <h3 class="text-white fw-semibold mb-1 fs-20">Hi, <span style="color: #FFE8D4;">Dr. Olivia!</span>
                            </h3>
                        ...
                        <div class="d-flex align-items-center flex-wrap gap-2 gap-xxl-4">
                            ...
                            <div class="d-flex align-items-center welcome-status-item">
                                <div class="flex-shrink-0">
                                    <i class="material-symbols-outlined text-primary-div"
                                        style="background-color: #F3E8FF;">local_library</i>
                                </div>
                                <div class="flex-grow-1 ms-3">
            ...
            <img src="/assets/images/shape-7.png" class="position-absolute top-50 end-0 translate-middle-y z-n1 h-100"
                alt="shape">
        </div>
        <div class="row">
            <div class="col-sm-6">
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center welcome-status-item mb-4">
                                <div class="flex-shrink-0">
                                    <i
                                        class="material-symbols-outlined icon-bg bg-primary bg-opacity-25 text-primary">airplay</i>
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex align-items-center welcome-status-item mb-4">
                                <div class="flex-shrink-0">
                                    <i
                                        class="material-symbols-outlined icon-bg bg-primary-div bg-opacity-25 text-primary-div">bed</i>
                                </div>
                                <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex align-items-center welcome-status-item mb-0">
                                <div class="flex-shrink-0">
                                    <i
                                        class="material-symbols-outlined icon-bg bg-success bg-opacity-25 text-success">featured_seasonal_and_gifts</i>
                                </div>
                                <div class="flex-grow-1 ms-3">
            ...
            <div class="card bg-white border-0 rounded-3 mb-4">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 pb-3">
                        ...
                        <select class="form-select month-select form-control h-auto pe-5 w-auto"
                            style="background-position: right 15px center; color: #64748B !important;"
                            ...
                            <table class="table align-middle border-0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="fw-medium">
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/images/user-71.png" class="rounded-circle"
                                        ...
                                        <td class="text-end">
                                            <span
                                                class="d-inline-block py-1 px-2 bg-success bg-opacity-10 rounded-2 text-success">Confirmed</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="fw-medium">
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/images/user-72.png" class="rounded-circle"
                                                    style="width: 34px; height: 34px;" alt="user">
                                        ...
                                        <td class="text-end">
                                            <span
                                                class="d-inline-block py-1 px-2 bg-danger-div bg-opacity-10 rounded-2 text-danger">Rescheduled</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="fw-medium">
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/images/user-73.png" class="rounded-circle"
                                                    style="width: 34px; height: 34px;" alt="user">
                                        ...
                                        <td class="text-end">
                                            <span
                                                class="d-inline-block py-1 px-2 bg-danger bg-opacity-10 rounded-2 text-danger">Cancelled</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="fw-medium">
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/images/user-74.png" class="rounded-circle"
                                                    style="width: 34px; height: 34px;" alt="user">
                                    ...
                                    <tr>
                                        ...
                                        <td class="fw-medium">
                                            <div class="d-flex align-items-center">
                                                <img src="/assets/images/user-75.png" class="rounded-circle"
                                                    style="width: 34px; height: 34px;" alt="user">
                                        ...
                                        <td class="text-end">
                                            <span
                                                class="d-inline-block py-1 px-2 bg-primary-div bg-opacity-10 rounded-2 text-primary-div">Pending</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        <div class="col-lg-5 col-xl-4 col-md-6">
            <div class="card border-0 rounded-3 mb-4" style="background-color: #7C24CC;">
                <div class="card-body p-4 py-5 p-xl-5 text-center">
                    ...
                    <p class="text-white fs-14 m-auto" style="max-width: 273px;">Quickly schedule an appointment for a
                        patient with any available doctor</p>
                    <div class="py-4 mb-2">
            ...
            <div class="card border-0 rounded-3 mb-4" style="background-color: #FFF5ED;">
                <div class="card-body p-4">
                    <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3 mb-lg-30">
                        ...
                        <select class="form-select month-select form-control p-0 h-auto border-0 w-90 bg-transparent"
                            style="background-position: right 0 center;" aria-label="Default select example">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="card bg-white p-4 border-0 rounded-3 mb-4 exchange-for-dark">
                                        ...
                                        <p class="fs-12 mb-0">Total Profit <span class="text-danger ms-1"> <i
                                                    class="ri-arrow-down-fill"></i>5%</span></p>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="card bg-white p-4 border-0 rounded-3 mb-4 exchange-for-dark">
                                        <h2 class="fs-24 fw-medium mb-1">$80,000</h2>
                                        <p class="fs-12 mb-0">Total Costs <span class="text-success ms-1"> <i
                                                    class="ri-arrow-up-fill"></i>3%</span></p>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                        ...
                                        <div class="card bg-white p-4 border-0 rounded-3 mb-0 exchange-for-dark">
                                            <div class="row align-items-center">
                                                <div class="col-lg-7">
                                                    ...
                                                    <p class="fs-12 mb-0">Total Earnings <span class="text-success ms-1">
                                                            <i class="ri-arrow-up-fill"></i>3%</span></p>
                                                </div>
                                                <div class="col-lg-5">

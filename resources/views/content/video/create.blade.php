        ...
        <div class="card-body p-0">
            <div class="p-4">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-3">
                    <h3 class="mb-0">Create a New Video</h3>
                </div>

                <form action="{{ route('content.video.store') }}" method="POST" class="form_save">
                    @csrf
                    <div class="row">
                        <!-- Title -->
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mb-4">
                                ...
                                <input required type="url" class="form-control" name="youtube_url"
                                       placeholder="https://youtube.com/..." value="{{ old('youtube_url') }}">
                                @error('youtube_url')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="d-flex flex-wrap gap-3">
                                ...
                                <button type="submit" class="btn btn-primary py-2 px-4 fw-medium fs-16">
                                    <i class="ri-add-line text-white fw-medium"></i> Save Video
                                </button>
                            </div>
                        </div>
                    </div>
